...
float cal_A = 394.2; // you can take the data from RX-9 bottom side QR data #### of first 4 digits. you type the data to cal_A as ###.#
float cal_B = 63.24; // following 4 digits after cal_A is cal_B, type the data to cal_B as ##.##
...
void loop() {
  ...
  if(time_s - time_s_prev >= time_s_set){
    ...
    if(status_sensor){
      ...
      Serial.print("Warming up, Please! Wait 3 Minutes");
