...
SERVER_URL = "http://192.168.0.59:5000/"
...
def animate(i):
   ...
   if stage != current_stage:
      stage = current_stage
      if stage == 1:
         send_command("raw/W0G0Y0R0")
      elif stage == 2:
         send_command("raw/W1G0Y0R0")
      elif stage == 3:
         send_command("raw/W1G1Y0R0")
      elif stage == 4:
         send_command("raw/W1G1Y1R0")
      elif stage == 5:
         send_command("raw/W1G1Y1R1")
   line.set_data(x, y)
