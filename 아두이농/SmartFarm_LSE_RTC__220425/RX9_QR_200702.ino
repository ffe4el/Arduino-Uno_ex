 ...
 */
#include "RX9QR.h"
#define EMF_pin A2 // 0   // RX-9 E with A0 of arduino
#define THER_pin A3 // 1  // RX-9 T with A1 of arduino
#define ADCvolt 5
...
float cal_A = 404.1; // you can take the data from RX-9 bottom side QR data #### of first 4 digits. you type the data to cal_A as ###.#
float cal_B = 62.05; // following 4 digits after cal_A is cal_B, type the data to cal_B as ##.##
